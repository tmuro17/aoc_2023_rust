...
#[aoc(day7, part2)]
pub fn part2(hands: &[Hand]) -> Result<usize> {
    Ok(hands
        .iter()
        .sorted()
        .enumerate()
...
mod parsers {
    ...
    use crate::day7::part2::{Card, Hand};
...
QQQJA 483";
    ...
    #[case("T55J5 684", HandType::FourKind)]
    #[case("KK677 28", HandType::TwoPair)]
    #[case("KTJJT 220", HandType::FourKind)]
    #[case("QQQJA 483", HandType::FourKind)]
    #[case("23456 0", HandType::HighCard)]
    #[case("2345J 0", HandType::OnePair)]
    #[case("2344J 0", HandType::ThreeKind)]
    #[case("4422J 0", HandType::FullHouse)]
    #[case("34JJJ 0", HandType::FourKind)]
    #[case("345JJ 0", HandType::ThreeKind)]
    #[case("335JJ 0", HandType::FourKind)]
    ...
    #[test]
    fn hand_sorting() -> Result<()> {
        let mut hands = input_generator(SAMPLE_INPUT)?;
        hands.sort();
        insta::assert_debug_snapshot!(hands);
        Ok(())
    }

    #[test]
    fn joker_sorting() -> Result<()> {
        let weaker: Hand = "JKKK2 5".try_into()?;
        let stronger: Hand = "QQQQ2 10".try_into()?;
